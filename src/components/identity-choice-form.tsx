...
export function IdentityChoiceForm() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-4xl mx-auto">
        <Card 
            className="text-center p-8 md:p-10 cursor-pointer hover:shadow-2xl hover:-translate-y-2 transition-transform duration-300 ease-in-out border-2 border-transparent hover:border-stone-800 bg-white"
        ...
        >
            <CardContent className="p-0">
                ...
                <h2 className="text-3xl font-bold font-sans text-stone-900">Sono un lettore</h2>
        ...
        <Card 
            className="text-center p-8 md:p-10 cursor-pointer hover:shadow-2xl hover:-translate-y-2 transition-transform duration-300 ease-in-out border-2 border-transparent hover:border-accent bg-white"
            onClick={() => setChoice('intermediary')}
        >
            <CardContent className="p-0">
                 <div className="mb-4 inline-flex h-20 w-20 items-center justify-center rounded-full bg-accent/10 text-accent">
                    <Building className="h-10 w-10" />
                </div>
                <h2 className="text-3xl font-bold font-sans text-stone-900">Ho un locale</h2>
                <p className="mt-2 text-stone-600">
...
function ReaderForm({ onBack }: { onBack: () => void }) {
    ...
    return (
        <div className="w-full max-w-lg mx-auto text-left bg-white p-8 rounded-lg shadow-lg">
        <h3 className="text-2xl font-bold text-center mb-2 font-sans text-stone-900">Sei dei nostri.</h3>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Label htmlFor="reader-email" className="font-sans text-stone-800">La tua email</Label>
            ...
            <div className="space-y-2">
            <Label htmlFor="reader-city" className="font-sans text-stone-800">La tua città</Label>
...
function IntermediaryForm({ onBack }: { onBack: () => void }) {
    ...
    return (
        <div className="w-full max-w-lg mx-auto text-left bg-white p-8 rounded-lg shadow-lg">
        <h3 className="text-2xl font-bold text-center mb-2 font-sans text-stone-900">Porta nuove persone nel tuo locale.</h3>
        <p className="text-center text-stone-700 mb-6">
            Candidati al nostro programma Founding Partner. È gratuito, senza vincoli e riservato ai primi 15 locali per città.
        </p>
        <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="space-y-2">
                <Label htmlFor="business-name" className="font-sans text-stone-800">Nome del locale</Label>
             ...
             <div className="space-y-2">
                <Label htmlFor="business-email" className="font-sans text-stone-800">Email di contatto</Label>
             ...
             <div className="space-y-2">
                <Label htmlFor="partner-city" className="font-sans text-stone-800">Città</Label>
            ...
            <Button type="submit" size="lg" className="w-full bg-accent hover:bg-accent/90 text-white rounded-full px-8 py-6 text-lg font-sans" disabled={isSubmitting}>
